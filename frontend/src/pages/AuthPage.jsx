    ...
    <div className="min-h-screen bg-[#f8f9fc] dark:bg-[#0d0f1a] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#0f1523] dark:text-[#eef0f8] tracking-tight">MailBot</h1>
          <p className="text-sm text-[#6b7280] dark:text-[#8b92b3] mt-1">Domain Subscription Manager</p>
        </div>
